...
**The best model that predicts swift parrot nest box occupancy as determined by Akaike's Information Criterion (AIC) includes both season and distance from forest edge. (include stats)**
...
labs(x = "Edge Distance", 
     ...
     color = "season", 
     fill = "season", 
     title = "Swift Parrot presence by distance from forest edge and season ") + 
  # y axis formatting 
