...
| 2            |  X  |                 | year predicts Swift Parrot nest box occupancy|
...
nest_boxes_clean <- nest_boxes |> 
  clean_names() |> 
  mutate(box_occupant = "swift_parrot", 
         edge_distance = as_factor(edge_distance), 
...
model1 <- glm(sp ~ edge_distance + season, # formula saturated model
             data = nest_boxes_clean,  # data frame 
              family = "binomial") #binomial distribution 
model2 <- glm(sp ~ edge_distance, # formula edge distance as predictor
             data = nest_boxes_clean,  # data frame 
            family = "binomial") #binomial distribution 
model3 <- glm(sp ~ season, # fromula season as predictor 
             data = nest_boxes_clean, # data frame 
              family = "binomial") #binomial distribution 
```
